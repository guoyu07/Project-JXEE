...
<html>
<head>
    <title>青创板企业列表--江西股权交易中心门户后台管理系统</title>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#"><i class="fa fa-pencil-square-o"></i> 青创版企业列表</a></li>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <form class="search-box" action="${pageContext.request.contextPath}/sys/qcblist">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-sm" name="keyname"
                                                       placeholder="输入企业名称" value="${keyname}">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <c:forEach items="${thelist}" var="thelist" varStatus="status">
                                                        <tr
                                                                <c:choose>
                                                                    <c:when test="${thelist.qstatus==0}"> class="danger" </c:when>
                                                                </c:choose>
                                                        >
                                                            <td>${thelist.cname}</td>
                                                            ...
                                                            <td>
                                                                <a href="${pageContext.request.contextPath}/sys/qcbinfo/${thelist.id}"
                                                                   class="btn btn-default btn-sm"><i
                                                                        class="fa fa-edit"></i> 详情</a>
                                                                <a href="${pageContext.request.contextPath}/sys/delqcb?keyname=${keyname }&city=${city }&industry=${industry }&curpageno=${currentpageno}&lyid=${thelist.id}"
                                                                   class="btn btn-default btn-sm"><i
